...
.def Flags = r23    ; Назначаем R23 регистром флагов
.equ FLAG_READ_DATETIME = 0      ; Бит 0: событие 1 секунда (от INT0)
.equ bBtn   = 1      ; Бит 1: нажата кнопка (от Timer1)
...
MAIN_LOOP:
    ...
    sbrs Flags, FLAG_READ_DATETIME ;Пропустить следующую команду если бит в регистре стоит
    rjmp sleep_all
	cbr Flags, (1<<FLAG_READ_DATETIME) ; СРАЗУ сбрасываем флаг, чтобы не обработать дважды
	rcall READ_DATETIME
...
INT0_DS3231:
	...
	sbr Flags, (1<<FLAG_READ_DATETIME)
